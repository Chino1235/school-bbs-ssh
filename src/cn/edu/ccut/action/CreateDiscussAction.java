...
import cn.edu.ccut.service.SubSectionService;
        ...
        try {//子板块名称上也有主板块名称
            if (mainSection != null && mainSection.length() > 0 && subSection != null && subSection.length() > 0) {
                ...
                if (res) {
                    ...
                    //更新session中的主板块信息
                    List<MainSection> mainSections = mainSectionService.getAllMainSection();
                    getSession().put("mainSections", mainSections);
